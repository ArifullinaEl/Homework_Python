...
# num_rows = 6
# num_columns = 6
# matrix = [[i * j for j in range(1,num_columns+1)] for i in range(1,num_rows+1)]
# for i in matrix:
#      print(*[f"{x:>2}" for x in i]) #знак > добавит указанное количество пробелов впереди, а знак < после.
