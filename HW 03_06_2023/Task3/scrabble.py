...
vcb_eng = {1:'AEIOULNSTR', 2:'DG', 3:'BCMP', 4:'FHVWY', 5:'K', 8:'JX', 10:'QZ'}
vcb_rus = {1:'АВЕИНОРСТ', 2:'ДКЛМПУ', 3:'БГЁЬЯ', 4:'ЙЫ', 5:'ЖЗХЦЧ', 8:'ШЭЮ', 10:'ФЩЪ'}
...
if word[0] in english:
    ...
    s = 0
    for i in word:
        for (k,v) in vcb_eng.items():
            if i in v:
                s += k
                
    print(f"Стоимость введенного слова: {s}")
